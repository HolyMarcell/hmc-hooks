...
export declare const registerRequest: ({ action, paginated, paginationMapper, arrayParamsStrategy, sortMapper, id }: RegisterRequestAction) => (dispatch: any, getState: any) => any;
